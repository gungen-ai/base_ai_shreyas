        ...
        {loading ? (
          ...
          <div className="space-y-3">
              ...
              <div>
                ...
                {openTickets.map(ticket => (
                  <div
                    ...
                    onClick={() => {
                      setSelected(ticket)
                      setAnswer(ticket.draftedAnswer || '')
                    }}
                    className={`bg-white rounded-xl border p-4 cursor-pointer transition-colors mb-2 ${
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full shrink-0 font-medium ${STATUS_COLORS[ticket.status]}`}>
                        {ticket.status}
                      </span>
                    </div>
            ...
            {resolvedTickets.length > 0 && (
              <div>
                <p className="text-xs font-medium text-gray-500 uppercase mb-2 px-1 mt-4">
                  Resolved
                </p>
                {resolvedTickets.map(ticket => (
                  <div
                    ...
                    className={`bg-white rounded-xl border p-4 cursor-pointer transition-colors mb-2 opacity-60 ${
                      selected?.id === ticket.id
                        ? 'border-indigo-400 ring-1 ring-indigo-400'
                        : 'border-gray-200 hover:border-gray-300'
                    }`}
              ...
              <div className="mb-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">
                    Add this answer to Knowledge Base
                  </span>
                </label>
